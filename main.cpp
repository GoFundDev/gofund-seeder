...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "GoFund-seeder\n"
...
static const string mainnet_seeds[] = {"seed1.go-fund-ico.com", ""};
static const string testnet_seeds[] = {"tseed1.go-fund-ico.com", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("45.32.184.167", 40881), true);
    db.Add(CService("95.179.139.63", 40881), true);
    db.Add(CService("95.179.148.144", 40881), true);
    db.Add(CService("95.179.170.230", 40881), true);
    db.Add(CService("217.163.28.202", 40881), true);
  }
  do {
